...
import type { Root, Paragraph, Link, Content } from 'mdast'
...
export const remarkGithubCard: Plugin = function () {
  return async function transformer(tree: Root) {
    const tasks: Array<Promise<void>> = []
    visit(tree, 'paragraph', (node: Paragraph, index: number | null, parent: Root | Paragraph | null) => {
